...
class CreateVoteStoreTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vote_detail_store', function (Blueprint $table) {

            //表的字段
            $table->unsignedInteger('id')->autoIncrement();
            $table->unsignedInteger('vote_id')->default(0)->comment('关联投票id');
            $table->string('store_code',50)->default('')->comment('分店代码');
    ...
    {
        Schema::dropIfExists('vote_detail_store');
    }
}
